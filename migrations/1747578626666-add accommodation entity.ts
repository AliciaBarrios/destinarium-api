...
export class addAccommodationEntity1747578626666 implements MigrationInterface {
    name = 'addAccommodationEntity1747578626666'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "accommodations" ("accommodationId" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "adress" character varying NOT NULL, "type" "accommodations_type_enum" NOT NULL, "price" numeric NOT NULL, "web" character varying, CONSTRAINT "PK_0608149a621b6f68225da99810c" PRIMARY KEY ("accommodationId"))`);
