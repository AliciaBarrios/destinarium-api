...
export class addVariableToAccommodationEntity1747848326350 implements MigrationInterface {
    name = 'addVariableToAccommodationEntity1747848326350'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "accommodations" ("accommodationId" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "address" character varying NOT NULL, "type" "accommodations_type_enum" NOT NULL, "price" numeric NOT NULL, "web" character varying, "serviceType" character varying NOT NULL DEFAULT 'alojamiento', CONSTRAINT "PK_0608149a621b6f68225da99810c" PRIMARY KEY ("accommodationId"))`);
